  ...
  */
  initialiseModule(moduleName) {
    ...
    try {
      ...
      return console.log(`${Errors.ModuleLoad}, ${Errors.MissingPackageJson}, ${e}`);
    }
    if(!moduleConfig.adapt_authoring.module) {
      return;
    }
    try { // try and import the module, and make sure it provides a function export
      ModClass = require(moduleName);
    } catch(e) {
      return console.log(`${Errors.ModuleLoad} '${moduleName}', ${e}\n\n${e.stack}`);
    }
