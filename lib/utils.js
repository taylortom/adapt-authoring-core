class Utils {
  /**
  * Extends a base class using composition
  * @param {Class} base Base class to extend
  * @param {...Function} mixins Mixin functions to apply
  * @return {Class} The new composite class
  * @todo need to be able to compose mixin functions as well as classes {@link https://github.com/adaptlearning/adapt_authoring/issues}
  */
  static compose(base, ...classes) {
    return classes.map((base, c) => class extends c {}, base);
  }
  /**
