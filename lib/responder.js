...
class Responder {
  ...
  * @property {Number} Success.post 201
  * @property {Number} Success.get 200
  * @property {Number} Success.put 200
  * @property {Number} Success.patch 200
  * @property {Number} Success.delete 204
  * @property {Object} Error Error status codes
  * @property {Number} Error.User 400
  * @property {Number} Error.Authenticate 401
  * @property {Number} Error.Authorise 403
  * @property {Number} Error.Missing 404
  */
